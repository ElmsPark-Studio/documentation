...
- **Fixes "Your session has expired. Please reload to ensure your security." on PageMotor 0.11.** The message appeared on saving from the editor even though you were signed in perfectly normally, and whatever you were doing failed to save.
